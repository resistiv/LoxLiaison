...
namespace LoxTester
{
    ...
    public class AssignmentTests
    {
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//associativity.lox");
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//global.lox");
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//grouping.lox");
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//infix_operator.lox");
            Assert.AreEqual(1, output.Length);
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//local.lox");
            Assert.AreEqual(4, output.Length);
            Assert.AreEqual("before", output[0]);
            Assert.AreEqual("after", output[1]);
            Assert.AreEqual("arg", output[2]);
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//prefix_operator.lox");
            Assert.AreEqual(1, output.Length);
            Assert.AreEqual("[line 2] Error at '=': Invalid assignment target.", output[0]);
        }
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//syntax.lox");
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//to_this.lox");
            Assert.AreEqual(1, output.Length);
            Assert.AreEqual("[line 3] Error at '=': Invalid assignment target.", output[0]);
        }
        ...
        {
            string[] output = Tools.RunFile("..//..//..//Tests//assignment//undefined.lox");
            Assert.AreEqual(2, output.Length);
