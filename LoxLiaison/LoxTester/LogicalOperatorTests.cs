...
namespace LoxTester
{
	...
	public class LogicalOperatorTests
	{
		...
		public void AndTest()
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/logical_operator/and.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/logical_operator/and_truth.lox");
		...
		public void OrTest()
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/logical_operator/or.lox");
			Assert.AreEqual(7, output.Length);
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/logical_operator/or_truth.lox");
			Assert.AreEqual(5, output.Length);
