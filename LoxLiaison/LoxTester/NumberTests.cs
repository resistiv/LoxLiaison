...
namespace LoxTester
{
	...
	public class NumberTests
	{
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/number/decimal_point_at_eof.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/number/leading_dot.lox");
			Assert.AreEqual(1, output.Length);
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/number/literals.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/number/trailing_dot.lox");
			Assert.AreEqual(1, output.Length);
