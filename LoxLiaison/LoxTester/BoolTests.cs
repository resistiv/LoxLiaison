...
namespace LoxTester
{
	...
	public class BoolTests
	{
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/bool/equality.lox");
		...
		public void NotTest()
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/bool/not.lox");
