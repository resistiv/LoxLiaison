...
namespace LoxTester
{
	...
	public class ForTests
	{
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/class_in_body.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/closure_in_body.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/fun_in_body.lox");
			Assert.AreEqual(1, output.Length);
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/return_closure.lox");
			Assert.AreEqual(1, output.Length);
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/return_inside.lox");
			Assert.AreEqual(1, output.Length);
			Assert.AreEqual("i", output[0]);
		}
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/scope.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/statement_condition.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/statement_increment.lox");
			Assert.AreEqual(1, output.Length);
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/statement_initializer.lox");
			Assert.AreEqual(2, output.Length);
			Assert.AreEqual("[line 3] Error at '{': Expect expression.", output[0]);
			Assert.AreEqual("[line 3] Error at ')': Expect ';' after expression.", output[1]);
		}
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/syntax.lox");
		...
		{
			string[] output = Tools.RunFile("/mnt/c/users/kai/source/repos/LoxLiaison/LoxLiaison/LoxTester/Tests/for/var_in_body.lox");
			Assert.AreEqual(1, output.Length);
